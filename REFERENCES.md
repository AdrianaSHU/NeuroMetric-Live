...
* Alarcao, S. M., & Fonseca, J. M. (2017). Emotions recognition using EEG signals: A survey. *IEEE Transactions on Affective Computing*, *10*(3), 374–393. <https://doi.org/10.1109/TAFFC.2017.2714671>

* Cao, L., Zhao, W., & Sun, B. (2024). Emotion recognition using multi-scale EEG features through graph convolutional attention network. *Neural Networks*, *184*, Article 107060. <https://doi.org/10.1016/j.neunet.2024.107060>

* Dalabehera, A. R., Bebortta, S., Kumar, N., & Senapati, D. (2024). Mist–fog-assisted real-time emotion recognition using deep transfer learning framework for smart city 4.0. *Internet of Things*, *27*, Article 101237. <https://doi.org/10.1016/j.iot.2024.101237>
...
* Murshed, M. G., Murphy, C., Hou, D., Kumar, N., Macedo, M., & Margala, M. (2021). Machine learning at the network edge: A survey. *ACM Computing Surveys (CSUR)*, *54*(8), 1–37. <https://doi.org/10.1145/3469029>

* Wu, Y., Mi, Q., & Gao, T. (2025). A comprehensive review of multimodal emotion recognition: Techniques, challenges, and future directions. *MDPI AG*. <https://doi.org/10.3390/biomimetics10070418>
